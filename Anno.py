#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To ANNOHACKER
...
▀▄▄▄▄▄▀▄▀▄▀▄▄▀▄▄▀▄▄▀▄▄▀▄▄▄▄▄▀▄▄▄▄▄▀▄▄▄▄▀▀
       \033[1;96m:▒▒▒▒███▒███▒███▒███▒▒▒▒▒▒▒▒▒▒:\033[1;95m♡
      \033[1;96m▒▒▒▒▒▒▒▒█▒█▒█▒▒▒█▒█▒█▒▒▒▒▒▒▒▒▒▒::\033[1;94m♡ANNONYMOUS
...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mPlease Wait A Few Minute \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
os.system("clear")
print  """
   \033[1;92m███████WELCOME TO ANNONYMOUS HACKER████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mS.Creations\033[1;95m♡╭───•◈•───╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mANNONYMOUSHACKER
\033[1;94mFacebook\033[1;91m: \033[1;91mANNONYMOUS
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mS.CREATIONS\033[1;95m♡╰───•◈•───╯♡"""
jalan('    \033[1;96m............ANNONYMOUS.CREATIONS...............:')
jalan("\033[1;95m   ┈┈┈STAY HOME  ")
jalan('\033[1;92m   ┈┈┈STAY SAFE ')
jalan('\033[1;93m   ┈┈┈WASH YOUR HANDS ')
print "\033[1;91m♡─────────♡\033[1;96mLogin To Annonumous\033[1;95m♡──•◈•──╯♡"

CorrectUsername = "anno"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:ANNONYMOUS-HACKER
	    time.sleep(2)
	
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open https://www.facebook.com/yit.h.lay)
    else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:ANNONYMOUS-HACKER
	print logo
	print "  \033[1;95m«-----♡----\033[1;93mLogged in User ID\033[1;95m----♡-----»"
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		idt = raw_input("\033[1;96m[♡] \033[1;92mEnter Your ID\033[1;93m: \033[1;97m")
		print "\033[1;95m♡──────────•◈•────♡\033[1;96mS.creations\033[1;95m♡────•◈•────♡"
		try:
	...
	jalan('\033[1;92mPlease Wait A Few Minute\033[1;93m...')
	titik = ['.   ','..  ','... ']
	for o in titik:
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mS.creations\033[1;95m♡───•◈•───────♡"
	print "  \033[1;93m«---•◈•---Developed By SHAKEEBr---•◈•---»" #Dev:ANNOYMOUS-HACKER
	...
	print """
              ...
              ████████████100%  
♡──────────────•◈•──────────────♡.
: \033[1;96m .....ANNONYMOUS-HACKERcreations............ \033[1;93m :
♡──────────────•◈•──────────────♡.' 
